 ...
 */
final class Version20211204200609 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program ADD CONSTRAINT FK_92ED77842CB716C7 FOREIGN KEY (yes_id) REFERENCES season (id)');
